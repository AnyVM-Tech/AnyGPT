...
export API_PROVIDERS_FILE="${API_PROVIDERS_FILE:-.tmp/test-data/providers.json}"
export API_KEYS_FILE="${API_KEYS_FILE:-.tmp/test-data/keys.json}"
export API_MODELS_FILE="${API_MODELS_FILE:-.tmp/test-data/models.json}"
